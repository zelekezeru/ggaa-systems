...
class LedgerReportExport implements FromArray, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        ...
        $rows = [
            ...
            ['  ↳ Receipt #: Start',                $l->cash_machine_start_number ?? '—'],
            ['  ↳ Receipt #: End',                  $l->cash_machine_end_number   ?? '—'],
            ['  ↳ Receipt Count (End − Start)',      $l->cash_machine_sales_count],
            ['Manual (Hand-to-Hand) Sales',          (float) $l->manual_sales],
            ['  ↳ Receipt #: Start',                $l->manual_receipt_start_number ?? '—'],
            ['  ↳ Receipt #: End',                  $l->manual_receipt_end_number   ?? '—'],
            ['  ↳ Receipt Count (End − Start)',      $l->manual_receipt_count],
            ...
            ['  ↳ Inventory Units (Start)',   $l->inventory_items_start  !== null ? (float) $l->inventory_items_start  : '—'],
            ['  ↳ Inventory Units (End)',     $l->inventory_items_end    !== null ? (float) $l->inventory_items_end    : '—'],
            ['  ↳ Units Sold This Month',     $l->inventory_sold_quantity !== null ? (float) $l->inventory_sold_quantity : '—'],
