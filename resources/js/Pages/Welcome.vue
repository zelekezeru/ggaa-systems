            ...
            <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div class="flex items-center gap-3 group cursor-pointer">
                    ...
                    <div class="flex flex-col -space-y-1">
                        ...
                        <span class="text-[8px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Gedion Girma Authorized Accountant</span>
                    </div>
                </div>
        ...
        <footer class="py-12 border-t border-slate-100 dark:border-slate-900">
            <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                    &copy; 2026 GGAA (Gedion Girma Authorized Accountant) . Built with Precision.
                </div>
