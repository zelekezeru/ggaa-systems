        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
            ...
            >
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center rounded-md border border-transparent bg-white dark:bg-gray-800 px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none"
                                            >
                ...
                >
                    ...
                    <div class="border-t border-gray-100 dark:border-slate-800 px-4 py-4">
                        <p class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-3">{{ $t('select_language') }}</p>
            ...
            <!-- Page Heading -->
            <header
                class="bg-white dark:bg-gray-800 shadow dark:border-gray-700 transition-colors duration-200"
                v-if="$slots.header"
            >
